...
void PPC64::build_func(PasmNode *ln) {
...
void PPC64::build_istret(PasmNode *ln) {
...
void PPC64::build_ptr_stret(PasmNode *ln) {
...
void PPC64::build_istrptr(PasmNode *ln) {
...
void PPC64::build_ret() {
}

//Push string argument
void PPC64::build_str_pusharg(PasmNode *ln) {
...
//Push byte argument
void PPC64::build_bpusharg(PasmNode *ln) {
...
void PPC64::build_ipusharg(PasmNode *ln) {
...
void PPC64::build_f32_pusharg(PasmNode *ln) {
...
void PPC64::build_f64_pusharg(PasmNode *ln) {
...
void PPC64::build_ptr_pusharg(PasmNode *ln) {
...
//Call a function
void PPC64::build_call(PasmNode *ln) {
